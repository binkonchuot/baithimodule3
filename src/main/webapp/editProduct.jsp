...
<form  method="post">
    ...
    <div class="form-group">
        <label>nhap lai price</label>
        <input type="number" class="form-control" name="price" aria-describedby="emailHelp" placeholder="enter price">
    </div>
    <div class="form-group">
        <label >nhap lai quantily</label>
        <input type="number" class="form-control" name="quantily" placeholder="enter quantily">
    </div>
    <div class="form-group">
        <label>nhap lai color</label>
        <input type="text" class="form-control" name="color" aria-describedby="emailHelp" placeholder="enter color">
    </div>
    <div class="form-group">
        <label>nhap lai description</label>
